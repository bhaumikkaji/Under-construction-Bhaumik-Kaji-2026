    ...
    >
      <div className="group relative overflow-hidden rounded-lg">
        <Link to={`/project/${project.id}`} className="block">
          ...
          <div className="mt-4">
            <span className="text-xs text-navy/60 uppercase tracking-wider">
              {project.category}
            </span>
            <h3 className="text-xl font-grotesk text-navy mt-1 group-hover:underline">
              {project.title}
            </h3>
            <p className="text-navy/70 mt-2 line-clamp-2">
              {project.description}
            </p>
            <div className="mt-4 inline-flex items-center text-navy font-medium">
              Learn More
        ...
        <>
          ...
          <section className="container mx-auto px-6 pt-20 mb-12">
            <AnimatedSection className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-grotesk text-navy mb-6">Projects</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                {Array.from({ length: 4 }).map((_, index) => (
                  <div key={index} className="animate-pulse mb-8">
                    <div className="bg-stone aspect-[4/3] rounded-lg"></div>
                    <div className="mt-4">
                      <div className="h-3 bg-stone w-16 rounded"></div>
                      <div className="h-6 bg-stone w-3/4 rounded mt-2"></div>
                      <div className="h-4 bg-stone w-full rounded mt-2"></div>
                      <div className="h-4 bg-stone w-1/2 rounded mt-2"></div>
                    </div>
                  </div>
                ))}
              </div>
